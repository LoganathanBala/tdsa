...
import clubpeople from "./Club/ClubDetails";
// import getImageUrl from "../pages/Club/ClubLogo";
// import bannerImg from "../pages/Club/ClubLogo";
        ...
        <div className="relative flex flex-col justify-between w-full align-middle items-center gap-10 md:flex-row">
          <div className="rounded-2xl w-1/3 flex items-center gap-5 bg-white p-5">
            ...
            <div className="relative flex flex-col">
              <h4 className="text-2xl font-semibold">{club.mastername} <sub className="text-sm absolute top-2.5 pl-1">{cmasterQulificationlub.}</sub></h4>
              <h6 className="text-blue-900">Founder and Master</h6>
            </div>
          </div>
          <div className="rounded-2xl w-1/3 flex items-center gap-5 bg-white p-5">
            <div className="rounded-full w-[30%]">
            ...
            <div className="relative flex flex-col">
              <h4 className="text-2xl font-semibold">{club.femalecocah} <sub className="text-sm absolute top-2.5 pl-1">{club.femaleQulification}</sub></h4>
          ...
          <div className="rounded-2xl w-1/3 flex items-center gap-5 bg-white p-5">
            ...
            <div className="relative flex flex-col">
              <h4 className="text-2xl font-semibold">{club.malecoach} <sub className="text-sm absolute top-2.5 pl-1">{club.maleQulfiacation}</sub></h4>
